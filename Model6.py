...
sheet = 'Sheet1' # номер таблиці

# завантажуємо дані з Excel у DataFrame за допомогою методу read_excel()
df = pd.read_excel(file_ex, sheet_name = sheet)

# вилучаємо перший стовпець із DataFrame і створюємо масив NumPy за допомогою методу to_numpy()
